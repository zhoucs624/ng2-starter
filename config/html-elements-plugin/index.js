 ...
 * @param { String } attrMap A Map of attribute names (keys) and their values.
 * @param { String } publicPath a path to add to eh start of static asset url
 * @return { String }
 */
function createTag(tagName, attrMap, publicPath) {
  ...
  /**
   * Add trailing slash if we have a publicPath and it does't have one.
   */
